...
controller.showHomepage = async (req, res) => {
    ...
    res.locals.featuredProducts = featuredProducts; //để gửi lên view
    ...
    const brands = await Brand.findAll(); //await để đợi bảng brand load xong
    res.render('index', { brands }); //hoặc là {brands : brands}
}

controller.showPage = (req, res, next) => {
    const pages = ['cart', 'checkout', 'contact', 'login', 'my-account', 'product-detail', 'products', 'wishlist'];
